...
RipplerXAudioProcessor::RipplerXAudioProcessor()
    ...
    , params(*this, &undoManager, "PARAMETERS", {
        ...
        std::make_unique<juce::AudioParameterFloat>("a_decay", "A Decay",juce::NormalisableRange<float>(0.01f, 100.0f, 0.01f, 0.3f) , 1.0f),
        ...
        std::make_unique<juce::AudioParameterFloat>("b_decay", "B Decay",juce::NormalisableRange<float>(0.01f, 100.0f, 0.01f, 0.3f), 1.0f),
